...
--[[ BEGIN CONFIGURATION ]]--
TRACKS = {'../states/MuteCityTA.state', '../states/MuteCityGP2.state', '../states/MuteCityGP.state'}
PLAY_FOR_FRAMES = {2300,500,600} -- Number of frames that each track is going to play
--[[ END CONFIGURATION ]]--
...
while true do
    ...
    if state > #TRACKS then state = 1 end -- loop track list
end
