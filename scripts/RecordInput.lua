--[[ BEGIN CONFIGURATION ]]--
RECORD_EVERY = 10 -- Record input and make a screenshot every # of frames
PLAY_FOR = 100 -- Target input and screenshots on this session. Game will end once goal is reached
USE_MAPPING = true
--[[ END CONFIGURATION ]]--
